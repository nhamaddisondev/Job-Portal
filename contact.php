        ...
        <div class="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
            <div>
                ...
                <div class="mt-8 space-y-5">
                    <div class="rounded-md border border-gray-200 bg-white p-5 shadow-sm">
                        ...
                        <a href="mailto:support@onlinejobportal.com" class="mt-1 inline-block text-sky-600 hover:text-sky-700">support@onlinejobportal.com</a>
                    </div>
                    <div class="rounded-md border border-gray-200 bg-white p-5 shadow-sm">
                        <p class="text-sm font-semibold text-gray-900">Phone</p>
                        <a href="tel:+11234567890" class="mt-1 inline-block text-sky-600 hover:text-sky-700">+1 (123) 456-7890</a>
                    </div>
                    <div class="rounded-md border border-gray-200 bg-white p-5 shadow-sm">
                        <p class="text-sm font-semibold text-gray-900">Office</p>
                        <p class="mt-1 text-gray-600">123 Career Street, New York, NY 10001</p>
                    </div>
                </div>
            </div>
            ...
            <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm md:p-8">
                <form action="" method="post" class="space-y-6">
                    ...
                    <button type="submit" class="inline-flex w-full items-center justify-center rounded-md bg-sky-600 px-5 py-3 text-sm font-semibold text-white shadow-sm hover:bg-sky-700 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2 md:w-auto">Send Message</button>
                </form>
            </div>
        </div>
    </section>
